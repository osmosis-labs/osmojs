...
export const GenesisState = {
  ...
  toJSON(message: GenesisState): unknown {
    ...
    message.anyPoolToInternalGauges !== undefined && (obj.anyPoolToInternalGauges = message.anyPoolToInternalGauges ? AnyPoolToInternalGauges.toJSON(message.anyPoolToInternalGauges) : undefined);
    message.concentratedPoolToNoLockGauges !== undefined && (obj.concentratedPoolToNoLockGauges = message.concentratedPoolToNoLockGauges ? ConcentratedPoolToNoLockGauges.toJSON(message.concentratedPoolToNoLockGauges) : undefined);
    return obj;
  },
