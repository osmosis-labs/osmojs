//@ts-nocheck
import { AssetID, AssetIDAmino, AssetIDSDKType, Params, ParamsAmino, ParamsSDKType, AssetStatus } from "./bridge";
...
export const MsgInboundTransfer = {
  ...
  is(o: any): o is MsgInboundTransfer {
    return o && (o.$typeUrl === MsgInboundTransfer.typeUrl || typeof o.externalId === "string" && typeof o.externalHeight === "bigint" && typeof o.sender === "string" && typeof o.destAddr === "string" && AssetID.is(o.assetId) && typeof o.amount === "string");
  },
  isSDK(o: any): o is MsgInboundTransferSDKType {
    return o && (o.$typeUrl === MsgInboundTransfer.typeUrl || typeof o.external_id === "string" && typeof o.external_height === "bigint" && typeof o.sender === "string" && typeof o.dest_addr === "string" && AssetID.isSDK(o.asset_id) && typeof o.amount === "string");
  },
  isAmino(o: any): o is MsgInboundTransferAmino {
    return o && (o.$typeUrl === MsgInboundTransfer.typeUrl || typeof o.external_id === "string" && typeof o.external_height === "bigint" && typeof o.sender === "string" && typeof o.dest_addr === "string" && AssetID.isAmino(o.asset_id) && typeof o.amount === "string");
  },
  encode(message: MsgInboundTransfer, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.assetId !== undefined) {
      AssetID.encode(message.assetId, writer.uint32(42).fork()).ldelim();
    }
    if (message.amount !== "") {
...
export const MsgOutboundTransfer = {
  ...
  is(o: any): o is MsgOutboundTransfer {
    return o && (o.$typeUrl === MsgOutboundTransfer.typeUrl || typeof o.sender === "string" && typeof o.destAddr === "string" && AssetID.is(o.assetId) && typeof o.amount === "string");
  },
  isSDK(o: any): o is MsgOutboundTransferSDKType {
    return o && (o.$typeUrl === MsgOutboundTransfer.typeUrl || typeof o.sender === "string" && typeof o.dest_addr === "string" && AssetID.isSDK(o.asset_id) && typeof o.amount === "string");
  },
  isAmino(o: any): o is MsgOutboundTransferAmino {
    return o && (o.$typeUrl === MsgOutboundTransfer.typeUrl || typeof o.sender === "string" && typeof o.dest_addr === "string" && AssetID.isAmino(o.asset_id) && typeof o.amount === "string");
  },
...
export const MsgChangeAssetStatus = {
  ...
  is(o: any): o is MsgChangeAssetStatus {
    return o && (o.$typeUrl === MsgChangeAssetStatus.typeUrl || typeof o.sender === "string" && AssetID.is(o.assetId) && isSet(o.newStatus));
  },
  isSDK(o: any): o is MsgChangeAssetStatusSDKType {
    return o && (o.$typeUrl === MsgChangeAssetStatus.typeUrl || typeof o.sender === "string" && AssetID.isSDK(o.asset_id) && isSet(o.new_status));
  },
  isAmino(o: any): o is MsgChangeAssetStatusAmino {
    return o && (o.$typeUrl === MsgChangeAssetStatus.typeUrl || typeof o.sender === "string" && AssetID.isAmino(o.asset_id) && isSet(o.new_status));
  },
