...
export declare class LCDQueryClient extends LCDClient {
    ...
    numPools(_params?: QueryNumPoolsRequest): Promise<QueryNumPoolsResponse>;
    totalLiquidity(_params?: QueryTotalLiquidityRequest): Promise<QueryTotalLiquidityResponse>;
