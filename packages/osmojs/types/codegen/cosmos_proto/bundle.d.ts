...
export declare const cosmos_proto: {
    ...
    InterfaceDescriptor: {
        typeUrl: string;
        encode(message: _172.InterfaceDescriptor, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
        decode(input: Uint8Array | import("protobufjs").Reader, length?: number): _172.InterfaceDescriptor;
    ...
    ScalarDescriptor: {
        typeUrl: string;
        encode(message: _172.ScalarDescriptor, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
        decode(input: Uint8Array | import("protobufjs").Reader, length?: number): _172.ScalarDescriptor;
