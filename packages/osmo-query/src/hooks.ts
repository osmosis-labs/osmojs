...
import * as _OsmosisSmartaccountV1beta1Queryrpc from "./osmosis/smartaccount/v1beta1/query.rpc.Query";
...
export const createRpcQueryHooks = ({
  ...
  return {
    ...
    osmosis: {
      ...
      smartaccount: {
        v1beta1: _OsmosisSmartaccountV1beta1Queryrpc.createRpcQueryHooks(rpc)
      },
