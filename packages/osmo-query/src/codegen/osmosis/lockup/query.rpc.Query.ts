...
export interface UseLockRewardReceiverQuery<TData> extends ReactQueryParams<LockRewardReceiverResponse, TData> {
  request: LockRewardReceiverRequest;
}
export interface UseNextLockIDQuery<TData> extends ReactQueryParams<NextLockIDResponse, TData> {
...
export interface UseSyntheticLockupByLockupIDQuery<TData> extends ReactQueryParams<SyntheticLockupByLockupIDResponse, TData> {
...
export const createRpcQueryHooks = (rpc: ProtobufRpcClient | undefined) => {
  ...
  const useLockRewardReceiver = <TData = LockRewardReceiverResponse,>({
    ...
    return useQuery<LockRewardReceiverResponse, Error, TData>(["lockRewardReceiverQuery", request], () => {
      if (!queryService) throw new Error("Query Service not initialized");
      return queryService.lockRewardReceiver(request);
    }, options);
  };
  const useNextLockID = <TData = NextLockIDResponse,>({
    ...
    return useQuery<NextLockIDResponse, Error, TData>(["nextLockIDQuery", request], () => {
      if (!queryService) throw new Error("Query Service not initialized");
      return queryService.nextLockID(request);
    }, options);
  };
  ...
  const useSyntheticLockupByLockupID = <TData = SyntheticLockupByLockupIDResponse,>({
    request,
    options
  }: UseSyntheticLockupByLockupIDQuery<TData>) => {
    return useQuery<SyntheticLockupByLockupIDResponse, Error, TData>(["syntheticLockupByLockupIDQuery", request], () => {
      if (!queryService) throw new Error("Query Service not initialized");
      return queryService.syntheticLockupByLockupID(request);
    }, options);
  };
